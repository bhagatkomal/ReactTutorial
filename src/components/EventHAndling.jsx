...
export const EventHandling = () => {
  ...
  return (
    <>
      ...
      <button className='bg-orange-200 border rounded-md px-8' onClick={() => handleWelcomeUser("vinod")}>click Me</button>
      <button className="bg-orange-200 border rounded-md px-8" onClick={() => handleWelcomeUser("Ram")}>click Me</button>
    </>
  );
};